...
useEffect(() => {
  ...
  return (
    <div className="flex h-screen aspect-square w-full border border-border rounded-md overflow-hidden">
      ...
      <div className="w-1/2 p-6 flex flex-col border-l">
        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          ...
          <div className="p-4 rounded-lg shadow-sm border border-gray-700">
            ...
            <div>
              {check ? isCheckmate() ?  (<span className="text-red-500 font-bold flex items-center">
                  ...
                  <div key={idx} className={`text-sm ${idx % 2 === 0 ? "col-span-1" : "col-span-1"}`}>
                    {idx % 2 === 0 ? (
                      <div className="flex items-center">
                        ...
                        <span className="font-medium">{move.from.x},{move.from.y} - {move.to.x},{move.to.y}</span>
                      </div>
                    ) : (
                      <div className="flex items-center">
